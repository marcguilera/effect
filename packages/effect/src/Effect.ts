...
export const fn:
  ...
  & ((
    ...
    function apply(self: any, body: Function, args: Array<any>, pipeables: Array<any>) {
    ...
    if (typeof nameOrBody !== "string") {
      return function(this: any) {
        return apply(this, nameOrBody, arguments as any, pipeables)
      } as any
    }
    ...
    return (body: Function, ...pipeables: Array<any>) => {
      return function(this: any, ...args: Array<any>) {
        ...
        const effect = apply(this, body, args, pipeables)
